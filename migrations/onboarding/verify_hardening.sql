...
--   * `has_table_privilege` / `has_function_privilege` hakki DOGRUDAN, PUBLIC
--     uzerinden ve rol uyeligi uzerinden TOPLAM olarak olcer -> unutulmus bir
--     `GRANT ... TO PUBLIC` de bu kontrolde YAKALANIR.
