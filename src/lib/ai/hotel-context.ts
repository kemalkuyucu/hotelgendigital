...
export async function buildHotelContext(
  ...
  return { hotelInfo, generalRules, knowledgeFacts, documents, nearbyPlaces };
}
...
async function fetchDocuments(
  ...
  let query = supabase
    ...
    .select('document_type, language, department_code, delivery_policy, display_text, file_name')
    .eq('is_active', true);
