...
import { listDocuments } from '@/lib/documents/document-client'
import DocumentsPageClient from './_documents-client'
...
export default async function DocumentsPage({
      ...
      <div style={{ padding: '40px', fontFamily: "'Inter', system-ui, sans-serif" }}>
        ...
        >
          ...
          <p style={{ color: '#64748b', fontSize: '14px', margin: 0 }}>
            Bu departmanın belgelerine erişim yetkiniz bulunmuyor.
          </p>
        </div>
      </div>
    )
  ...
  const documents = await listDocuments(tenant.hotelSupabase, dept)
