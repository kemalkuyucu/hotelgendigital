  ...
  return (
    <div style={{ maxWidth: 820, margin: '0 auto', padding: '40px 24px', width: '100%' }}>
      ...
      <p style={{ color: '#94a3b8', marginBottom: 28, fontSize: 14.5, lineHeight: 1.6, maxWidth: 620 }}>
        Excel dosyanızı yükleyin; bot anında yeni menüyü okumaya başlar. Yeni yükleme,
        mevcut menünün tamamının yerini alır.
      </p>

      {/* Kolon sablonu rozetleri */}
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8, marginBottom: 28 }}>
        {['Urun Adi', 'Kategori', 'Fiyat', 'Para Birimi', 'Ucretli mi'].map((c) => (
          <span
            key={c}
            style={{
              fontSize: 12.5,
      ...
      {step === 'done' && (
        <div style={{ ...card, padding: 36, textAlign: 'center', borderColor: 'rgba(52,211,153,0.3)' }}>
          ...
          <p style={{ fontSize: 19, fontWeight: 600, color: '#f1f5f9', margin: '0 0 6px' }}>Menü yüklendi</p>
          <p style={{ color: '#94a3b8', fontSize: 14.5, margin: '0 0 22px' }}>
            <b style={{ color: '#34d399' }}>{resultCount}</b> ürün kaydedildi. Bot artık yeni menüyü okuyor.
          </p>
